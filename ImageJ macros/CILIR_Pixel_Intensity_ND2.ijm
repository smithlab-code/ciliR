...
// doi: https://doi.org/10.1101/2023.12.20.572306



macro "RAW DATA FOR CILIR" {
Dialog.create("ciliR Pixel Intensity Macro - Rules");
Dialog.addMessage("\n");
...
for (i=0; i<list.length; i++) {
 	...
 	filename = dir1 + list[i];
 	   run("Bio-Formats Importer", "open=[filename] open_all_series concatenate_series autoscale color_mode=Default crop specify_range t_begin=1 t_end=[CROP_TYPE] t_step=[CROP2_TYPE]");
