#rm(list=ls())
#' @export
analyse_cilia2 <- function(path, FRate, NFrame, NoiseLevel, UpperLimit){
  ...
  for (i in 1:l){
    my_data <- utils::read.delim(file_list[i],  header = TRUE, stringsAsFactors = FALSE, check.names = FALSE)
